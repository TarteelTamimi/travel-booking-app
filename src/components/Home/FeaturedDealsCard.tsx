  ...
  return (
    <div onClick={handleCardClick} className="relative w-full sm:w-10/12 md:w-9/12 lg:w-10/12 xl:w-8/12 border h-[500px] md:h-[350px] rounded-2xl bg-white cursor-pointer shadow mb-5">
      ...
      <div className="p-4 md:p-3">
        ...
        <div className="flex justify-between mx-3 sm:mt-5">
          ...
          <a href="#" onClick={handleBookNow} className="inline-flex items-center px-3 py-2 text-lg font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
            Book Now
          </a>
        </div>
      </div>
